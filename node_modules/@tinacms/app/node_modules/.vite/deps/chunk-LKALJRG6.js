...
async function importCodeMirror(addons, options) {
  const CodeMirror = await import("./codemirror.es-L26X5DGA.js").then(function(n2) {
    return n2.c;
  }).then((c2) => typeof c2 === "function" ? c2 : c2.default);
  await Promise.all((options == null ? void 0 : options.useCommonAddons) === false ? addons : [
    import("./show-hint.es-RGVRBXJB.js").then(function(n2) {
      return n2.s;
    }),
    import("./matchbrackets.es-D7DD53KJ.js").then(function(n2) {
      return n2.m;
    }),
    import("./closebrackets.es-6JD7SAX3.js").then(function(n2) {
      return n2.c;
    }),
    import("./brace-fold.es-3MCLDKNV.js").then(function(n2) {
      return n2.b;
    }),
    import("./foldgutter.es-D7MINH42.js").then(function(n2) {
      return n2.f;
    }),
    import("./lint.es3-SHJ4BAFK.js").then(function(n2) {
      return n2.l;
    }),
    import("./searchcursor.es-RU7MZNNZ.js").then(function(n2) {
      return n2.s;
    }),
    import("./jump-to-line.es-7TC6LTPC.js").then(function(n2) {
      return n2.j;
    }),
    import("./dialog.es-LSL5IFBF.js").then(function(n2) {
      return n2.d;
    }),
    import("./sublime.es-VGH465KV.js").then(function(n2) {
      return n2.s;
    }),
    ...addons
  ]);
...
function useHeaderEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./javascript.es-UI7UCPEE.js").then(function(n2) {
        return n2.j;
      })
    ]).then((CodeMirror) => {
      if (!isActive) {
...
function useQueryEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./comment.es-N2NMETQR.js").then(function(n2) {
        return n2.c;
      }),
      import("./search.es-SNEF5XF7.js").then(function(n2) {
        return n2.s;
      }),
      import("./hint.es-SR6VVOOJ.js"),
      import("./lint.es-ZVJQQC22.js"),
      import("./info.es-7A2ZB7OM.js"),
      import("./jump.es-KAYYLSTM.js"),
      import("./mode.es-YPD6AMIF.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function useVariableEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./hint.es2-AYHRPY62.js"),
      import("./lint.es2-KJOO2QFY.js"),
      import("./mode.es3-4ECY5NBK.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function useResponseEditor({
  ...
  (0, import_react.useEffect)(() => {
    ...
    importCodeMirror([
      ...
      import("./mode.es2-5ODYLXQR.js"),
      import("./info-addon.es-O3UCKJ3I.js")
    ], {
...
@graphiql/react/dist/index.es.js:
  ...
  ***************************************************************************** *)
   ...
   *)
*/
//# sourceMappingURL=chunk-LKALJRG6.js.map
