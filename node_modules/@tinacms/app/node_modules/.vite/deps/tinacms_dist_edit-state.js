...
var TinaEditProvider = ({
  ...
  return import_react.default.createElement(EditProvider, null, showEditButton && import_react.default.createElement(ToggleButton, null), import_react.default.createElement(TinaEditProviderInner, {
    ...props
  }));
};
function useTina({
  ...
  * See https://tina.io/blog/upgrading-to-iframe/ for full migration details
  ...
  const [waitForContextRerender, setWaitForContextRerender] = (0, import_react.useState)(!isDummyContainer);
...
var ToggleButton = () => {
  ...
  return edit || isOnAdmin ? null : import_react.default.createElement("div", {
