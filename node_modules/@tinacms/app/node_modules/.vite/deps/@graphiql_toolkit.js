...
async function e(e2, t) {
  const n = e2.headers["content-type"];
  if (!n || !~n.indexOf("multipart/mixed"))
    return e2;
  const i = n.indexOf("boundary="), r = i + 9, o = n.indexOf(";", r);
  return async function* (e3, t2, n2) {
    const i2 = !n2 || !n2.multiple;
    let r2 = Buffer.byteLength(t2), o2 = Buffer.alloc(0), s = true, f = [];
    e:
      for await (const n3 of e3) {
        const e4 = n3.indexOf(t2);
        let c = o2.byteLength;
        for (o2 = Buffer.concat([o2, n3]), ~e4 ? c += e4 : c = o2.indexOf(t2), f = []; ~c; ) {
          const e5 = o2.slice(0, c), n4 = o2.slice(c + r2);
          if (s)
            s = false, t2 = "\r\n" + t2, r2 += 2;
          else {
            const t3 = {}, r3 = e5.indexOf("\r\n\r\n") + 4, s2 = String(o2.slice(0, r3)).trim().split("\r\n");
            let c2;
            for (; c2 = s2.shift(); )
              c2 = c2.split(": "), t3[c2.shift().toLowerCase()] = c2.join(": ");
            const l = e5.lastIndexOf("\r\n", r3);
            let d = e5.slice(r3, l > -1 ? void 0 : l), a = false;
            if (c2 = t3["content-type"], c2 && ~c2.indexOf("application/json"))
              try {
                d = JSON.parse(String(d)), a = true;
              } catch (e6) {
              }
            if (c2 = { headers: t3, body: d, json: a }, i2 ? yield c2 : f.push(c2), 45 === n4[0] && 45 === n4[1])
              break e;
          }
          o2 = n4, c = o2.indexOf(t2);
        }
        f.length && (yield f);
      }
    f.length && (yield f);
  }(e2, `--${~i ? n.substring(r, o > -1 ? o : void 0).replace(/['"]/g, "").trim() : "-"}`, t);
}
...
var createSimpleFetcher = (options, httpFetch) => (graphQLParams, fetcherOpts) => __awaiter(void 0, void 0, void 0, function* () {
