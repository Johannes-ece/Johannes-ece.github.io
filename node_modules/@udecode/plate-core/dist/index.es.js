...
import React, { forwardRef, useEffect, useMemo, useRef, useCallback, memo } from 'react';
import { ReactEditor, withReact, DefaultElement, Editable, useSlateStatic, useSlate, Slate } from 'slate-react';
import { createStore } from '@udecode/zustood';
export { createStore } from '@udecode/zustood';
import { withHistory, HistoryEditor } from 'slate-history';
import { Editor, Element, Text, createEditor as createEditor$1, Range, Node as Node$1, Span, Path, Point, Transforms } from 'slate';
...
const createPlatesStore = (initialState = {}) => createStore('plate')(initialState).extendActions(set => ({
  /**
   * Set state by id.
...
const EditorRefEffect = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, editor.plugins.map(plugin => /*#__PURE__*/React.createElement(EditorRefPluginEffect, {
    key: plugin.key,
    plugin: plugin
  })));
};
...
const PlateContent = ({
  ...
  return /*#__PURE__*/React.createElement(Slate, slateProps, firstChildren, renderEditable ? renderEditable(editable) : editable, /*#__PURE__*/React.createElement(EditorStateEffect, {
    id: options.id
...
const Plate = props => {
  ...
  return /*#__PURE__*/React.createElement(JotaiProvider, {
    ...
    scope: scope
  }, /*#__PURE__*/React.createElement(PlateContent, props));
};
...
const PlateEventProvider = ({
  ...
  return /*#__PURE__*/React.createElement(PlateProvider, {
    id: id,
    scope: scope
  }, children);
};
...
export { Box, CARRIAGE_RETURN, DOM_HANDLERS, DefaultLeaf, ELEMENT_DEFAULT, EditablePlugins, EditorRefEffect, EditorRefPluginEffect, EditorStateEffect, ElementProvider, ElementProviderChild, Hotkeys, IS_APPLE, JotaiProvider, KEY_DESERIALIZE_AST, KEY_DESERIALIZE_HTML, KEY_EVENT_EDITOR, KEY_INLINE_VOID, KEY_INSERT_DATA, LINE_FEED, NO_BREAK_SPACE, Plate, PlateContent, PlateEventProvider, PlateProvider, PlateTest, SCOPE_PLATE, SPACE, TAB, ZERO_WIDTH_SPACE, addMark, applyDeepToNodes, blurEditor, cleanHtmlBrElements, cleanHtmlCrLf, cleanHtmlEmptyElements, cleanHtmlFontElements, cleanHtmlLinkElements, cleanHtmlTextNodes, collapseSelection, composeEventHandlers, composeRefs, copyBlockMarksToSpanChild, createAtomStore, createComponentAs, createDeserializeAstPlugin, createDeserializeHtmlPlugin, createDocumentNode, createElementAs, createEventEditorPlugin, createHistoryPlugin, createInlineVoidPlugin, createInsertDataPlugin, createNode, createNodeHOC, createNodesHOC, createNodesWithHOC, createPathRef, createPlateEditor, createPlateStore, createPlatesStore, createPluginFactory, createPlugins, createPointRef, createRangeRef, createReactPlugin, createTEditor, defaultsDeepToNodes, deleteBackward, deleteForward, deleteFragment, deleteMerge, deleteText, deselect, deselectEditor, deserializeHtml, deserializeHtmlElement, deserializeHtmlNode, deserializeHtmlNodeChildren, elementMatches, elementStore, escapeRegExp, eventEditorActions, eventEditorSelectors, eventEditorStore, findDescendant, findEditorDocumentOrShadowRoot, findEventRange, findHtmlElement, findHtmlParentElement, findNode, findNodeKey, findNodePath, flattenDeepPlugins, focusEditor, getAboveNode, getBlockAbove, getChildren, getCommonNode, getEdgeBlocksAbove, getEdgePoints, getEditorString, getEditorWindow, getEndPoint, getEventEditorId, getFirstNode, getFragment, getHandler, getHtmlComments, getInjectedPlugins, getKeyByType, getKeysByTypes, getLastChild$1 as getLastChild, getLastChildPath, getLastNode, getLastNodeByLevel, getLeafNode, getLevels, getMark, getMarks, getNextNode, getNextSiblingNodes, getNode, getNodeAncestor, getNodeAncestors, getNodeChild, getNodeChildren, getNodeDescendant, getNodeDescendants, getNodeElements, getNodeEntries, getNodeEntry, getNodeFirstNode, getNodeFragment, getNodeLastNode, getNodeLeaf, getNodeLevels, getNodeParent, getNodeProps, getNodeString, getNodeTexts, getNodes, getOperations, getParentNode, getPath, getPathRefs, getPlateActions, getPlateEditorRef, getPlatePlugins, getPlateSelectors, getPlateStore, getPlugin, getPluginInjectProps, getPluginOptions, getPluginType, getPluginTypes, getPlugins, getPluginsByKey, getPoint, getPointAfter, getPointBefore, getPointBeforeLocation, getPointFromLocation, getPointNextToVoid, getPointRefs, getPositions, getPreventDefaultHandler, getPreviousBlockById, getPreviousNode, getPreviousPath, getQueryOptions, getRange, getRangeBefore, getRangeFromBlockStart, getRangeRefs, getRenderNodeProps, getSelectionText, getSlateClass, getStartPoint, getTEditor, getVoidNode, hasBlocks, hasEditorDOMNode, hasInlines, hasNode, hasSingleChild, hasTexts, hexToBase64, htmlBodyToFragment, htmlBrToNewLine, htmlElementToElement, htmlElementToLeaf, htmlStringToDOMNode, htmlTextNodeToString, insertBreak, insertData, insertElements, insertEmptyElement, insertFragment, insertNode, insertNodes, insertText, isAncestor, isAncestorEmpty, isBlock, isBlockAboveEmpty, isBlockTextEmptyAfterSelection, isCollapsed, isComposing, isDefined, isDescendant, isEdgePoint, isEditor, isEditorFocused, isEditorNormalizing, isEditorReadOnly, isElement, isElementEmpty, isElementList, isEndPoint, isEventHandled, isExpanded, isFirstChild, isHistoryEditor, isHistoryMerging, isHistorySaving, isHtmlBlockElement, isHtmlComment, isHtmlElement, isHtmlFragmentHref, isHtmlText, isInline, isLastChild, isMarkActive, isNode, isNodeList, isNull, isOlSymbol, isPointAtWordEnd, isRangeAcrossBlocks, isRangeInSingleText, isSelectionAtBlockEnd, isSelectionAtBlockStart, isSelectionExpanded, isStartPoint, isText, isTextByPath, isTextList, isType, isUndefined, isUndefinedOrNull, isUrl, isVoid, isWordAfterTrigger, liftNodes, mapInjectPropsToPlugin, match, mergeDeepPlugins, mergeDeepToNodes, mergeNodes, mockPlugin, moveChildren, moveNodes, moveSelection, nodeMatches, normalizeDescendantsToDocumentFragment, normalizeEditor, normalizeInitialValue, onKeyDownToggleElement, onKeyDownToggleMark, overridePluginsByKey, parseHtmlDocument, parseHtmlElement, pipeDecorate, pipeDeserializeHtmlElement, pipeDeserializeHtmlLeaf, pipeHandler, pipeInjectProps, pipeInsertDataQuery, pipeInsertFragment, pipeOnChange, pipeRenderElement, pipeRenderLeaf, pipeTransformData, pipeTransformFragment, plateIdAtom, platesActions, platesSelectors, platesStore, pluginDeserializeHtml, pluginInjectProps, pluginRenderElement, pluginRenderLeaf, postCleanHtml, preCleanHtml, queryEditor, queryNode, removeEditorMark, removeHtmlNodesBetweenComments, removeHtmlSurroundings, removeMark, removeNodes, replaceTagName, select, selectEditor, selectEndOfBlockAboveSelection, setDefaultPlugin, setElements, setFragmentData, setMarks, setNodes, setPlatePlugins, setPlateState, setPoint, setSelection, someHtmlElement, someNode, splitNodes, textEquals, textMatches, toDOMNode, toDOMPoint, toDOMRange, toSlateNode, toSlatePoint, toSlateRange, toggleMark, toggleNodeType, toggleWrapNodes, traverseHtmlComments, traverseHtmlElements, traverseHtmlNode, traverseHtmlTexts, unhangRange, unsetNodes, unwrapHtmlElement, unwrapNodes, useComposedRef, useEditableProps, useEditorRef, useEditorState, useElement, useElementStore, useEventEditorId, useEventEditorSelectors, useEventPlateId, usePlate, usePlateEditorRef, usePlateEditorState, usePlateEffects, usePlateId, usePlatePlugins, usePlateSelection, usePlateSelectors, usePlateStore, usePlateStoreEffects, usePlatesSelectors, usePlatesStoreEffect, useSlateProps, useWrapElement, withHOC, withInlineVoid, withInsertData, withPlate, withPlateEventProvider, withPlateProvider, withProps, withProviders, withTHistory, withTReact, withoutMergingHistory, withoutNormalizing, withoutSavingHistory, wrapNodes };
